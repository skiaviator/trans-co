...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.GET,"/buses/**").hasAnyRole("ADMIN","CUSTOMER","DRIVER","EMPLOYEE")
                .antMatchers(HttpMethod.POST,"/buses/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.PUT,"/buses/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.DELETE,"/buses/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PATCH,"/buses/**").hasAnyRole("ADMIN","EMPLOYEE")

                .antMatchers(HttpMethod.GET,"/customers/**").hasAnyRole("ADMIN","EMPLOYEE","DRIVER","CUSTOMER")
                .antMatchers(HttpMethod.POST,"/customers/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT,"/customers/**").hasAnyRole("ADMIN","CUSTOMER","EMPLOYEE")
                .antMatchers(HttpMethod.DELETE,"/customers/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PATCH,"/customers/**").hasAnyRole("ADMIN","DRIVER","EMPLOYEE")

                .antMatchers(HttpMethod.GET,"/drivers/**").hasAnyRole("ADMIN","DRIVER","EMPLOYEE")
                .antMatchers(HttpMethod.POST,"/drivers/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.PUT,"/drivers/**").hasAnyRole("ADMIN","DRIVER","EMPLOYEE")
                .antMatchers(HttpMethod.DELETE,"/drivers/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PATCH,"/drivers/**").hasAnyRole("ADMIN","EMPLOYEE")
                ...
                .antMatchers(HttpMethod.GET,"/routes/**").hasAnyRole("ADMIN","CUSTOMER","DRIVER","EMPLOYEE")
                .antMatchers(HttpMethod.POST,"/routes/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.PUT,"/routes/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.DELETE,"/routes/**").hasRole("ADMIN")

                .antMatchers(HttpMethod.GET,"/schedule/**").hasAnyRole("ADMIN","CUSTOMER","DRIVER","EMPLOYEE")
                .antMatchers(HttpMethod.POST,"/schedule/**").hasAnyRole("ADMIN","EMPLOYEE")
                .antMatchers(HttpMethod.PUT,"/schedule/**").hasAnyRole("ADMIN","EMPLOYEE")
